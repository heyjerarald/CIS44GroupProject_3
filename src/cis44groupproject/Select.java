...
public class Select extends javax.swing.JFrame {
    ...
    public Select(LinkedBag<Student> studentBag, Queue<Student> waitingList, Stack<Student> studentStack) {
...
Menu window = new Menu(studentBag, waitingList, studentStack);
window.setVisible(true);// TODO add your handling code here:
    ...
    Stack<Student> studentStack = new Stack<>();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Select(studentBag, waitingList, studentStack).setVisible(true);
            }
        });
    }
